...
// handleOutboundIp takes the first usable answer and cancels the losers so they stop occupying probe slots.
// Url is the source asked, not where it redirected, and Body is raw: Dart owns the sources and their parsers.
