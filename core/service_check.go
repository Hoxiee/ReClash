...
var serviceCheckers = []serviceChecker{
	...
	// The RU-5 have no unlock semantics; reachability is what the region asks.
	{name: "instagram", check: checkReachable("https://www.instagram.com/")},
	{name: "x", check: checkReachable("https://x.com/")},
	{name: "discord", check: checkReachable("https://discord.com/")},
	{name: "twitch", check: checkReachable("https://www.twitch.tv/")},
	{name: "steam", check: checkReachable("https://store.steampowered.com/")},
	{name: "telegram", check: checkReachable("https://web.telegram.org/")},
	{name: "whatsapp", check: checkReachable("https://web.whatsapp.com/")},
	{name: "yandex", check: checkReachable("https://ya.ru/")},
}
