...
@useResult
$Res call({
 String? locale,@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) AppRegion? region,@JsonKey(fromJson: dashboardWidgetsSafeFormJson) List<DashboardWidget> dashboardWidgets, bool onlyStatisticsProxy, NotificationSettings notificationSettings, bool autoLaunch, bool silentLaunch, bool highPriorityAutoLaunch, bool autoRun, bool openLogs, bool closeConnections, bool newDashboard, String testUrl, bool isAnimateToPage, bool autoCheckUpdate, bool showLabel, bool disclaimerAccepted, bool setupCompleted, int setupStep, bool crashlyticsTip, bool crashlytics, bool minimizeOnExit, bool hidden, bool developerMode, bool smartRoutingDiagnostics, RestoreStrategy restoreStrategy, bool showTrayTitle, bool checkCertificate,@JsonKey(readValue: _readUserAgents) List<String> userAgents, bool sendDeviceIdentity, String iconVariant, bool reduceMotion, List<String> serviceOrder, List<String> disabledServices, String currentService, bool hideIp
});
...
as bool,smartRoutingDiagnostics: null == smartRoutingDiagnostics ? _self.smartRoutingDiagnostics : smartRoutingDiagnostics // ignore: cast_nullable_to_non_nullable
...
as List<String>,sendDeviceIdentity: null == sendDeviceIdentity ? _self.sendDeviceIdentity : sendDeviceIdentity // ignore: cast_nullable_to_non_nullable
...
as String,hideIp: null == hideIp ? _self.hideIp : hideIp // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of AppSettingProps
...
@override@JsonKey() final  bool smartRoutingDiagnostics;
...
mixin _$SmartRoutingProps {
 ...
 bool get enabled; SmartRoutingPreset get preset; SmartRoutingStrategy get strategy; List<String> get censorCountries; List<String> get canaryForeign; List<String> get canaryDomestic; List<RcxMarker> get openMarkers; List<RcxMarker> get domesticMarkers; List<RcxMarker> get localMarkers; List<String> get nameHints; List<String> get egressEchoes; List<String> get countryEchoes; List<String> get breakerPatterns; List<RcxNodeRule> get nodeRules; List<String> get avoidCountries; List<int> get latencyBands; bool get allowDomesticLastResort; bool get requireUdp; bool get respectPick; int get dwellSeconds; int get waveWidth; int get absCeilingMs; int get degradeConfirmSeconds; int get proofTtlMinutes;
...
int get hashCode {
  final _this = this as SmartRoutingProps;
  return Object.hashAll([runtimeType,_this.enabled,_this.preset,_this.strategy,const DeepCollectionEquality().hash(_this.censorCountries),const DeepCollectionEquality().hash(_this.canaryForeign),const DeepCollectionEquality().hash(_this.canaryDomestic),const DeepCollectionEquality().hash(_this.openMarkers),const DeepCollectionEquality().hash(_this.domesticMarkers),const DeepCollectionEquality().hash(_this.localMarkers),const DeepCollectionEquality().hash(_this.nameHints),const DeepCollectionEquality().hash(_this.egressEchoes),const DeepCollectionEquality().hash(_this.countryEchoes),const DeepCollectionEquality().hash(_this.breakerPatterns),const DeepCollectionEquality().hash(_this.nodeRules),const DeepCollectionEquality().hash(_this.avoidCountries),const DeepCollectionEquality().hash(_this.latencyBands),_this.allowDomesticLastResort,_this.requireUdp,_this.respectPick,_this.dwellSeconds,_this.waveWidth,_this.absCeilingMs,_this.degradeConfirmSeconds,_this.proofTtlMinutes]);
}

@override
String toString() {
  final _this = this as SmartRoutingProps;
  return 'SmartRoutingProps(enabled: ${_this.enabled}, preset: ${_this.preset}, strategy: ${_this.strategy}, censorCountries: ${_this.censorCountries}, canaryForeign: ${_this.canaryForeign}, canaryDomestic: ${_this.canaryDomestic}, openMarkers: ${_this.openMarkers}, domesticMarkers: ${_this.domesticMarkers}, localMarkers: ${_this.localMarkers}, nameHints: ${_this.nameHints}, egressEchoes: ${_this.egressEchoes}, countryEchoes: ${_this.countryEchoes}, breakerPatterns: ${_this.breakerPatterns}, nodeRules: ${_this.nodeRules}, avoidCountries: ${_this.avoidCountries}, latencyBands: ${_this.latencyBands}, allowDomesticLastResort: ${_this.allowDomesticLastResort}, requireUdp: ${_this.requireUdp}, respectPick: ${_this.respectPick}, dwellSeconds: ${_this.dwellSeconds}, waveWidth: ${_this.waveWidth}, absCeilingMs: ${_this.absCeilingMs}, degradeConfirmSeconds: ${_this.degradeConfirmSeconds}, proofTtlMinutes: ${_this.proofTtlMinutes})';
}
...
@useResult
$Res call({
 bool enabled, SmartRoutingPreset preset, SmartRoutingStrategy strategy, List<String> censorCountries, List<String> canaryForeign, List<String> canaryDomestic, List<RcxMarker> openMarkers, List<RcxMarker> domesticMarkers, List<RcxMarker> localMarkers, List<String> nameHints, List<String> egressEchoes, List<String> countryEchoes, List<String> breakerPatterns, List<RcxNodeRule> nodeRules, List<String> avoidCountries, List<int> latencyBands, bool allowDomesticLastResort, bool requireUdp, bool respectPick, int dwellSeconds, int waveWidth, int absCeilingMs, int degradeConfirmSeconds, int proofTtlMinutes
});
...
/// Create a copy of SmartRoutingProps
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? enabled = null,Object? preset = null,Object? strategy = null,Object? censorCountries = null,Object? canaryForeign = null,Object? canaryDomestic = null,Object? openMarkers = null,Object? domesticMarkers = null,Object? localMarkers = null,Object? nameHints = null,Object? egressEchoes = null,Object? countryEchoes = null,Object? breakerPatterns = null,Object? nodeRules = null,Object? avoidCountries = null,Object? latencyBands = null,Object? allowDomesticLastResort = null,Object? requireUdp = null,Object? respectPick = null,Object? dwellSeconds = null,Object? waveWidth = null,Object? absCeilingMs = null,Object? degradeConfirmSeconds = null,Object? proofTtlMinutes = null,}) {
...
class _SmartRoutingProps implements SmartRoutingProps {
  const _SmartRoutingProps({this.enabled = false, this.preset = SmartRoutingPreset.off, this.strategy = SmartRoutingStrategy.balanced,  List<String> censorCountries = const [],  List<String> canaryForeign = const [],  List<String> canaryDomestic = const [],  List<RcxMarker> openMarkers = const [],  List<RcxMarker> domesticMarkers = const [],  List<RcxMarker> localMarkers = const [],  List<String> nameHints = const [],  List<String> egressEchoes = const [],  List<String> countryEchoes = const [],  List<String> breakerPatterns = const [],  List<RcxNodeRule> nodeRules = const [],  List<String> avoidCountries = const [],  List<int> latencyBands = const [], this.allowDomesticLastResort = true, this.requireUdp = false, this.respectPick = true, this.dwellSeconds = 90, this.waveWidth = 12, this.absCeilingMs = 300, this.degradeConfirmSeconds = 60, this.proofTtlMinutes = 30}): _censorCountries = censorCountries,_canaryForeign = canaryForeign,_canaryDomestic = canaryDomestic,_openMarkers = openMarkers,_domesticMarkers = domesticMarkers,_localMarkers = localMarkers,_nameHints = nameHints,_egressEchoes = egressEchoes,_countryEchoes = countryEchoes,_breakerPatterns = breakerPatterns,_nodeRules = nodeRules,_avoidCountries = avoidCountries,_latencyBands = latencyBands;
...
@override@JsonKey() List<RcxMarker> get localMarkers {
...
@override@JsonKey() List<String> get nameHints {
...
@override@JsonKey() List<String> get countryEchoes {
...
@override@JsonKey() List<RcxNodeRule> get nodeRules {
...
@override@JsonKey() List<String> get avoidCountries {
...
@override@JsonKey() List<int> get latencyBands {
...
@override@JsonKey() final  int absCeilingMs;
@override@JsonKey() final  int degradeConfirmSeconds;
@override@JsonKey() final  int proofTtlMinutes;
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,enabled,preset,strategy,const DeepCollectionEquality().hash(_censorCountries),const DeepCollectionEquality().hash(_canaryForeign),const DeepCollectionEquality().hash(_canaryDomestic),const DeepCollectionEquality().hash(_openMarkers),const DeepCollectionEquality().hash(_domesticMarkers),const DeepCollectionEquality().hash(_localMarkers),const DeepCollectionEquality().hash(_nameHints),const DeepCollectionEquality().hash(_egressEchoes),const DeepCollectionEquality().hash(_countryEchoes),const DeepCollectionEquality().hash(_breakerPatterns),const DeepCollectionEquality().hash(_nodeRules),const DeepCollectionEquality().hash(_avoidCountries),const DeepCollectionEquality().hash(_latencyBands),allowDomesticLastResort,requireUdp,respectPick,dwellSeconds,waveWidth,absCeilingMs,degradeConfirmSeconds,proofTtlMinutes]);
}

@override
String toString() {
    return 'SmartRoutingProps(enabled: $enabled, preset: $preset, strategy: $strategy, censorCountries: $censorCountries, canaryForeign: $canaryForeign, canaryDomestic: $canaryDomestic, openMarkers: $openMarkers, domesticMarkers: $domesticMarkers, localMarkers: $localMarkers, nameHints: $nameHints, egressEchoes: $egressEchoes, countryEchoes: $countryEchoes, breakerPatterns: $breakerPatterns, nodeRules: $nodeRules, avoidCountries: $avoidCountries, latencyBands: $latencyBands, allowDomesticLastResort: $allowDomesticLastResort, requireUdp: $requireUdp, respectPick: $respectPick, dwellSeconds: $dwellSeconds, waveWidth: $waveWidth, absCeilingMs: $absCeilingMs, degradeConfirmSeconds: $degradeConfirmSeconds, proofTtlMinutes: $proofTtlMinutes)';
}
