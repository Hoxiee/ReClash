...
mixin _$TrayState {
 ...
 Mode get mode; int get port; bool get autoLaunch; bool get systemProxy; bool get tunEnable; bool get isStart; bool get paused; List<Group> get groups; Map<String, String> get selectedMap; bool get showTrayTitle; Map<HotAction, HotKeyAction> get hotKeys;
...
int get hashCode {
  final _this = this as TrayState;
  return Object.hash(runtimeType,_this.mode,_this.port,_this.autoLaunch,_this.systemProxy,_this.tunEnable,_this.isStart,_this.paused,const DeepCollectionEquality().hash(_this.groups),const DeepCollectionEquality().hash(_this.selectedMap),_this.showTrayTitle,const DeepCollectionEquality().hash(_this.hotKeys));
}

@override
String toString() {
  final _this = this as TrayState;
  return 'TrayState(mode: ${_this.mode}, port: ${_this.port}, autoLaunch: ${_this.autoLaunch}, systemProxy: ${_this.systemProxy}, tunEnable: ${_this.tunEnable}, isStart: ${_this.isStart}, paused: ${_this.paused}, groups: ${_this.groups}, selectedMap: ${_this.selectedMap}, showTrayTitle: ${_this.showTrayTitle}, hotKeys: ${_this.hotKeys})';
}
...
@useResult
$Res call({
 Mode mode, int port, bool autoLaunch, bool systemProxy, bool tunEnable, bool isStart, bool paused, List<Group> groups, Map<String, String> selectedMap, bool showTrayTitle, Map<HotAction, HotKeyAction> hotKeys
});
...
/// Create a copy of TrayState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? mode = null,Object? port = null,Object? autoLaunch = null,Object? systemProxy = null,Object? tunEnable = null,Object? isStart = null,Object? paused = null,Object? groups = null,Object? selectedMap = null,Object? showTrayTitle = null,Object? hotKeys = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Mode mode,  int port,  bool autoLaunch,  bool systemProxy,  bool tunEnable,  bool isStart,  bool paused,  List<Group> groups,  Map<String, String> selectedMap,  bool showTrayTitle,  Map<HotAction, HotKeyAction> hotKeys)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrayState() when $default != null:
return $default(_that.mode,_that.port,_that.autoLaunch,_that.systemProxy,_that.tunEnable,_that.isStart,_that.paused,_that.groups,_that.selectedMap,_that.showTrayTitle,_that.hotKeys);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Mode mode,  int port,  bool autoLaunch,  bool systemProxy,  bool tunEnable,  bool isStart,  bool paused,  List<Group> groups,  Map<String, String> selectedMap,  bool showTrayTitle,  Map<HotAction, HotKeyAction> hotKeys)  $default,) {final _that = this;
switch (_that) {
case _TrayState():
return $default(_that.mode,_that.port,_that.autoLaunch,_that.systemProxy,_that.tunEnable,_that.isStart,_that.paused,_that.groups,_that.selectedMap,_that.showTrayTitle,_that.hotKeys);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Mode mode,  int port,  bool autoLaunch,  bool systemProxy,  bool tunEnable,  bool isStart,  bool paused,  List<Group> groups,  Map<String, String> selectedMap,  bool showTrayTitle,  Map<HotAction, HotKeyAction> hotKeys)?  $default,) {final _that = this;
switch (_that) {
case _TrayState() when $default != null:
return $default(_that.mode,_that.port,_that.autoLaunch,_that.systemProxy,_that.tunEnable,_that.isStart,_that.paused,_that.groups,_that.selectedMap,_that.showTrayTitle,_that.hotKeys);case _:
  return null;
...
class _TrayState implements TrayState {
  const _TrayState({required this.mode, required this.port, required this.autoLaunch, required this.systemProxy, required this.tunEnable, required this.isStart, required this.paused, required  List<Group> groups, required  Map<String, String> selectedMap, required this.showTrayTitle,  Map<HotAction, HotKeyAction> hotKeys = const <HotAction, HotKeyAction>{}}): _groups = groups,_selectedMap = selectedMap,_hotKeys = hotKeys;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _TrayState&&(identical(other.mode, mode) || other.mode == mode)&&(identical(other.port, port) || other.port == port)&&(identical(other.autoLaunch, autoLaunch) || other.autoLaunch == autoLaunch)&&(identical(other.systemProxy, systemProxy) || other.systemProxy == systemProxy)&&(identical(other.tunEnable, tunEnable) || other.tunEnable == tunEnable)&&(identical(other.isStart, isStart) || other.isStart == isStart)&&(identical(other.paused, paused) || other.paused == paused)&&const DeepCollectionEquality().equals(other.groups, _groups)&&const DeepCollectionEquality().equals(other.selectedMap, _selectedMap)&&(identical(other.showTrayTitle, showTrayTitle) || other.showTrayTitle == showTrayTitle)&&const DeepCollectionEquality().equals(other.hotKeys, _hotKeys));
}


@override
int get hashCode {
    return Object.hash(runtimeType,mode,port,autoLaunch,systemProxy,tunEnable,isStart,paused,const DeepCollectionEquality().hash(_groups),const DeepCollectionEquality().hash(_selectedMap),showTrayTitle,const DeepCollectionEquality().hash(_hotKeys));
}

@override
String toString() {
    return 'TrayState(mode: $mode, port: $port, autoLaunch: $autoLaunch, systemProxy: $systemProxy, tunEnable: $tunEnable, isStart: $isStart, paused: $paused, groups: $groups, selectedMap: $selectedMap, showTrayTitle: $showTrayTitle, hotKeys: $hotKeys)';
}
...
/// Create a copy of TrayState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? mode = null,Object? port = null,Object? autoLaunch = null,Object? systemProxy = null,Object? tunEnable = null,Object? isStart = null,Object? paused = null,Object? groups = null,Object? selectedMap = null,Object? showTrayTitle = null,Object? hotKeys = null,}) {
...
@useResult
$Res call({
 String profilesPath, int? profileId, Map<String, dynamic> rawConfig, PatchClashConfig realPatchConfig, bool overrideDns, bool appendSystemDns, bool overrideNetwork, List<ProxyGroup> proxyGroups, List<Rule> rules, List<Rule> addedRules, String defaultUA, bool smartRouting, List<ServiceRoutePolicy> serviceRoutePolicies, Map<String, List<String>> serviceRules, List<String> authentication, String? matchTarget, bool desync, int desyncPort, List<DesyncCategory> desyncCategories, bool desyncForceTcp, bool desyncOnly
});
...
as List<ServiceRoutePolicy>,serviceRules: null == serviceRules ? _self.serviceRules : serviceRules // ignore: cast_nullable_to_non_nullable
as Map<String, List<String>>,authentication: null == authentication ? _self.authentication : authentication // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String profilesPath,  int? profileId,  Map<String, dynamic> rawConfig,  PatchClashConfig realPatchConfig,  bool overrideDns,  bool appendSystemDns,  bool overrideNetwork,  List<ProxyGroup> proxyGroups,  List<Rule> rules,  List<Rule> addedRules,  String defaultUA,  bool smartRouting,  List<ServiceRoutePolicy> serviceRoutePolicies,  Map<String, List<String>> serviceRules,  List<String> authentication,  String? matchTarget,  bool desync,  int desyncPort,  List<DesyncCategory> desyncCategories,  bool desyncForceTcp,  bool desyncOnly)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MakeRealProfileState() when $default != null:
return $default(_that.profilesPath,_that.profileId,_that.rawConfig,_that.realPatchConfig,_that.overrideDns,_that.appendSystemDns,_that.overrideNetwork,_that.proxyGroups,_that.rules,_that.addedRules,_that.defaultUA,_that.smartRouting,_that.serviceRoutePolicies,_that.serviceRules,_that.authentication,_that.matchTarget,_that.desync,_that.desyncPort,_that.desyncCategories,_that.desyncForceTcp,_that.desyncOnly);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String profilesPath,  int? profileId,  Map<String, dynamic> rawConfig,  PatchClashConfig realPatchConfig,  bool overrideDns,  bool appendSystemDns,  bool overrideNetwork,  List<ProxyGroup> proxyGroups,  List<Rule> rules,  List<Rule> addedRules,  String defaultUA,  bool smartRouting,  List<ServiceRoutePolicy> serviceRoutePolicies,  Map<String, List<String>> serviceRules,  List<String> authentication,  String? matchTarget,  bool desync,  int desyncPort,  List<DesyncCategory> desyncCategories,  bool desyncForceTcp,  bool desyncOnly)  $default,) {final _that = this;
switch (_that) {
case _MakeRealProfileState():
return $default(_that.profilesPath,_that.profileId,_that.rawConfig,_that.realPatchConfig,_that.overrideDns,_that.appendSystemDns,_that.overrideNetwork,_that.proxyGroups,_that.rules,_that.addedRules,_that.defaultUA,_that.smartRouting,_that.serviceRoutePolicies,_that.serviceRules,_that.authentication,_that.matchTarget,_that.desync,_that.desyncPort,_that.desyncCategories,_that.desyncForceTcp,_that.desyncOnly);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String profilesPath,  int? profileId,  Map<String, dynamic> rawConfig,  PatchClashConfig realPatchConfig,  bool overrideDns,  bool appendSystemDns,  bool overrideNetwork,  List<ProxyGroup> proxyGroups,  List<Rule> rules,  List<Rule> addedRules,  String defaultUA,  bool smartRouting,  List<ServiceRoutePolicy> serviceRoutePolicies,  Map<String, List<String>> serviceRules,  List<String> authentication,  String? matchTarget,  bool desync,  int desyncPort,  List<DesyncCategory> desyncCategories,  bool desyncForceTcp,  bool desyncOnly)?  $default,) {final _that = this;
switch (_that) {
case _MakeRealProfileState() when $default != null:
return $default(_that.profilesPath,_that.profileId,_that.rawConfig,_that.realPatchConfig,_that.overrideDns,_that.appendSystemDns,_that.overrideNetwork,_that.proxyGroups,_that.rules,_that.addedRules,_that.defaultUA,_that.smartRouting,_that.serviceRoutePolicies,_that.serviceRules,_that.authentication,_that.matchTarget,_that.desync,_that.desyncPort,_that.desyncCategories,_that.desyncForceTcp,_that.desyncOnly);case _:
  return null;
...
class _MakeRealProfileState implements MakeRealProfileState {
  const _MakeRealProfileState({required this.profilesPath, required this.profileId, required  Map<String, dynamic> rawConfig, required this.realPatchConfig, required this.overrideDns, required this.appendSystemDns, this.overrideNetwork = false, required  List<ProxyGroup> proxyGroups, required  List<Rule> rules, required  List<Rule> addedRules, required this.defaultUA, this.smartRouting = false,  List<ServiceRoutePolicy> serviceRoutePolicies = const [],  Map<String, List<String>> serviceRules = const {},  List<String> authentication = const [], this.matchTarget, this.desync = false, this.desyncPort = defaultDesyncPort,  List<DesyncCategory> desyncCategories = const [], this.desyncForceTcp = true, this.desyncOnly = false}): _rawConfig = rawConfig,_proxyGroups = proxyGroups,_rules = rules,_addedRules = addedRules,_serviceRoutePolicies = serviceRoutePolicies,_serviceRules = serviceRules,_authentication = authentication,_desyncCategories = desyncCategories;
...
@override@JsonKey() List<ServiceRoutePolicy> get serviceRoutePolicies {
 ...
 final  Map<String, List<String>> _serviceRules;
@override@JsonKey() Map<String, List<String>> get serviceRules {
  if (_serviceRules is EqualUnmodifiableMapView) return _serviceRules;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_serviceRules);
}
...
as List<ServiceRoutePolicy>,serviceRules: null == serviceRules ? _self._serviceRules : serviceRules // ignore: cast_nullable_to_non_nullable
as Map<String, List<String>>,authentication: null == authentication ? _self._authentication : authentication // ignore: cast_nullable_to_non_nullable
as List<String>,matchTarget: freezed == matchTarget ? _self.matchTarget : matchTarget // ignore: cast_nullable_to_non_nullable
as String?,desync: null == desync ? _self.desync : desync // ignore: cast_nullable_to_non_nullable
as bool,desyncPort: null == desyncPort ? _self.desyncPort : desyncPort // ignore: cast_nullable_to_non_nullable
...
mixin _$SetupState {
 ...
 int? get profileId; int? get profileLastUpdateDate; OverwriteType get overwriteType; List<Rule> get rules; List<ProxyGroup> get proxyGroups; List<Rule> get addedRules; Script? get script; bool get overrideDns; Dns get dns; List<ServiceRoutePolicy> get serviceRoutePolicies; Map<String, List<String>> get serviceRules; String? get matchTarget;
...
@useResult
$Res call({
 int? profileId, int? profileLastUpdateDate, OverwriteType overwriteType, List<Rule> rules, List<ProxyGroup> proxyGroups, List<Rule> addedRules, Script? script, bool overrideDns, Dns dns, List<ServiceRoutePolicy> serviceRoutePolicies, Map<String, List<String>> serviceRules, String? matchTarget
});
...
as List<ServiceRoutePolicy>,serviceRules: null == serviceRules ? _self.serviceRules : serviceRules // ignore: cast_nullable_to_non_nullable
as Map<String, List<String>>,matchTarget: freezed == matchTarget ? _self.matchTarget : matchTarget // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of SetupState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? profileId,  int? profileLastUpdateDate,  OverwriteType overwriteType,  List<Rule> rules,  List<ProxyGroup> proxyGroups,  List<Rule> addedRules,  Script? script,  bool overrideDns,  Dns dns,  List<ServiceRoutePolicy> serviceRoutePolicies,  Map<String, List<String>> serviceRules,  String? matchTarget)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SetupState() when $default != null:
return $default(_that.profileId,_that.profileLastUpdateDate,_that.overwriteType,_that.rules,_that.proxyGroups,_that.addedRules,_that.script,_that.overrideDns,_that.dns,_that.serviceRoutePolicies,_that.serviceRules,_that.matchTarget);case _:
  return orElse();
...
class _SetupState implements SetupState {
  const _SetupState({required this.profileId, required this.profileLastUpdateDate, required this.overwriteType, required  List<Rule> rules, required  List<ProxyGroup> proxyGroups, required  List<Rule> addedRules, required this.script, required this.overrideDns, required this.dns,  List<ServiceRoutePolicy> serviceRoutePolicies = const [],  Map<String, List<String>> serviceRules = const {}, this.matchTarget}): _rules = rules,_proxyGroups = proxyGroups,_addedRules = addedRules,_serviceRoutePolicies = serviceRoutePolicies,_serviceRules = serviceRules;
