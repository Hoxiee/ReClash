...
mixin _$PanelMeta {
 ...
 bool get hwidMaxDevicesReached; bool get hwidNotSupported; String? get announce; String? get supportUrl; String? get reportUrl; int? get updateIntervalMinutes; String? get serviceName; String? get serviceLogo; String? get serverInfoGroup; String? get buyPlanUrl; String? get buyTrafficUrl; List<String>? get widgets; PanelWidgetsApplyMode get widgetsApplyMode; List<String>? get settings; String? get newDomain; String? get profileTitle; String? get accountUsername; String? get proxiesView; String? get themeHex; String? get background; String? get heroRing; String? get heroEffect; String? get activeText;
...
int get hashCode {
  final _this = this as PanelMeta;
  return Object.hashAll([runtimeType,_this.hwidMaxDevicesReached,_this.hwidNotSupported,_this.announce,_this.supportUrl,_this.reportUrl,_this.updateIntervalMinutes,_this.serviceName,_this.serviceLogo,_this.serverInfoGroup,_this.buyPlanUrl,_this.buyTrafficUrl,const DeepCollectionEquality().hash(_this.widgets),_this.widgetsApplyMode,const DeepCollectionEquality().hash(_this.settings),_this.newDomain,_this.profileTitle,_this.accountUsername,_this.proxiesView,_this.themeHex,_this.background,_this.heroRing,_this.heroEffect,_this.activeText]);
}

@override
String toString() {
  final _this = this as PanelMeta;
  return 'PanelMeta(hwidMaxDevicesReached: ${_this.hwidMaxDevicesReached}, hwidNotSupported: ${_this.hwidNotSupported}, announce: ${_this.announce}, supportUrl: ${_this.supportUrl}, reportUrl: ${_this.reportUrl}, updateIntervalMinutes: ${_this.updateIntervalMinutes}, serviceName: ${_this.serviceName}, serviceLogo: ${_this.serviceLogo}, serverInfoGroup: ${_this.serverInfoGroup}, buyPlanUrl: ${_this.buyPlanUrl}, buyTrafficUrl: ${_this.buyTrafficUrl}, widgets: ${_this.widgets}, widgetsApplyMode: ${_this.widgetsApplyMode}, settings: ${_this.settings}, newDomain: ${_this.newDomain}, profileTitle: ${_this.profileTitle}, accountUsername: ${_this.accountUsername}, proxiesView: ${_this.proxiesView}, themeHex: ${_this.themeHex}, background: ${_this.background}, heroRing: ${_this.heroRing}, heroEffect: ${_this.heroEffect}, activeText: ${_this.activeText})';
}
...
@useResult
$Res call({
 bool hwidMaxDevicesReached, bool hwidNotSupported, String? announce, String? supportUrl, String? reportUrl, int? updateIntervalMinutes, String? serviceName, String? serviceLogo, String? serverInfoGroup, String? buyPlanUrl, String? buyTrafficUrl, List<String>? widgets, PanelWidgetsApplyMode widgetsApplyMode, List<String>? settings, String? newDomain, String? profileTitle, String? accountUsername, String? proxiesView, String? themeHex, String? background, String? heroRing, String? heroEffect, String? activeText
});
...
/// Create a copy of PanelMeta
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? hwidMaxDevicesReached = null,Object? hwidNotSupported = null,Object? announce = freezed,Object? supportUrl = freezed,Object? reportUrl = freezed,Object? updateIntervalMinutes = freezed,Object? serviceName = freezed,Object? serviceLogo = freezed,Object? serverInfoGroup = freezed,Object? buyPlanUrl = freezed,Object? buyTrafficUrl = freezed,Object? widgets = freezed,Object? widgetsApplyMode = null,Object? settings = freezed,Object? newDomain = freezed,Object? profileTitle = freezed,Object? accountUsername = freezed,Object? proxiesView = freezed,Object? themeHex = freezed,Object? background = freezed,Object? heroRing = freezed,Object? heroEffect = freezed,Object? activeText = freezed,}) {
...
as String?,accountUsername: freezed == accountUsername ? _self.accountUsername : accountUsername // ignore: cast_nullable_to_non_nullable
...
as String?,heroRing: freezed == heroRing ? _self.heroRing : heroRing // ignore: cast_nullable_to_non_nullable
as String?,heroEffect: freezed == heroEffect ? _self.heroEffect : heroEffect // ignore: cast_nullable_to_non_nullable
as String?,activeText: freezed == activeText ? _self.activeText : activeText // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool hwidMaxDevicesReached,  bool hwidNotSupported,  String? announce,  String? supportUrl,  String? reportUrl,  int? updateIntervalMinutes,  String? serviceName,  String? serviceLogo,  String? serverInfoGroup,  String? buyPlanUrl,  String? buyTrafficUrl,  List<String>? widgets,  PanelWidgetsApplyMode widgetsApplyMode,  List<String>? settings,  String? newDomain,  String? profileTitle,  String? accountUsername,  String? proxiesView,  String? themeHex,  String? background,  String? heroRing,  String? heroEffect,  String? activeText)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PanelMeta() when $default != null:
return $default(_that.hwidMaxDevicesReached,_that.hwidNotSupported,_that.announce,_that.supportUrl,_that.reportUrl,_that.updateIntervalMinutes,_that.serviceName,_that.serviceLogo,_that.serverInfoGroup,_that.buyPlanUrl,_that.buyTrafficUrl,_that.widgets,_that.widgetsApplyMode,_that.settings,_that.newDomain,_that.profileTitle,_that.accountUsername,_that.proxiesView,_that.themeHex,_that.background,_that.heroRing,_that.heroEffect,_that.activeText);case _:
  return orElse();
...
class _PanelMeta implements PanelMeta {
  const _PanelMeta({this.hwidMaxDevicesReached = false, this.hwidNotSupported = false, this.announce, this.supportUrl, this.reportUrl, this.updateIntervalMinutes, this.serviceName, this.serviceLogo, this.serverInfoGroup, this.buyPlanUrl, this.buyTrafficUrl,  List<String>? widgets, this.widgetsApplyMode = PanelWidgetsApplyMode.add,  List<String>? settings, this.newDomain, this.profileTitle, this.accountUsername, this.proxiesView, this.themeHex, this.background, this.heroRing, this.heroEffect, this.activeText}): _widgets = widgets,_settings = settings;
...
@override final  String? accountUsername;
@override final  String? proxiesView;
@override final  String? themeHex;
@override final  String? background;
@override final  String? heroRing;
@override final  String? heroEffect;
@override final  String? activeText;
