...
int get hashCode {
  final _this = this as PanelMeta;
  return Object.hashAll([runtimeType,_this.hwidMaxDevicesReached,_this.hwidNotSupported,_this.announce,_this.supportUrl,_this.updateIntervalMinutes,_this.serviceName,_this.serviceLogo,_this.serverInfoGroup,_this.buyPlanUrl,_this.buyTrafficUrl,const DeepCollectionEquality().hash(_this.widgets),_this.widgetsApplyMode,const DeepCollectionEquality().hash(_this.settings),_this.newDomain,_this.profileTitle,_this.accountUsername,_this.proxiesView,_this.themeHex,_this.background,_this.heroRing,_this.heroEffect,_this.activeText]);
}
...
@useResult
$Res call({
 bool hwidMaxDevicesReached, bool hwidNotSupported, String? announce, String? supportUrl, int? updateIntervalMinutes, String? serviceName, String? serviceLogo, String? serverInfoGroup, String? buyPlanUrl, String? buyTrafficUrl, List<String>? widgets, PanelWidgetsApplyMode widgetsApplyMode, List<String>? settings, String? newDomain, String? profileTitle, String? accountUsername, String? proxiesView, String? themeHex, String? background, String? heroRing, String? heroEffect, String? activeText
});
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,hwidMaxDevicesReached,hwidNotSupported,announce,supportUrl,updateIntervalMinutes,serviceName,serviceLogo,serverInfoGroup,buyPlanUrl,buyTrafficUrl,const DeepCollectionEquality().hash(_widgets),widgetsApplyMode,const DeepCollectionEquality().hash(_settings),newDomain,profileTitle,accountUsername,proxiesView,themeHex,background,heroRing,heroEffect,activeText]);
}
