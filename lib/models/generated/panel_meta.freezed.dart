...
mixin _$PanelMeta {
 ...
 bool get hwidMaxDevicesReached; bool get hwidNotSupported; String? get announce; String? get supportUrl; int? get updateIntervalMinutes; String? get serviceName; String? get serviceLogo; String? get serverInfoGroup; String? get buyPlanUrl; String? get buyTrafficUrl; List<String>? get widgets; PanelWidgetsApplyMode get widgetsApplyMode; List<String>? get settings; String? get newDomain; String? get profileTitle; String? get accountUsername; String? get proxiesView; String? get themeHex;
...
int get hashCode {
  final _this = this as PanelMeta;
  return Object.hash(runtimeType,_this.hwidMaxDevicesReached,_this.hwidNotSupported,_this.announce,_this.supportUrl,_this.updateIntervalMinutes,_this.serviceName,_this.serviceLogo,_this.serverInfoGroup,_this.buyPlanUrl,_this.buyTrafficUrl,const DeepCollectionEquality().hash(_this.widgets),_this.widgetsApplyMode,const DeepCollectionEquality().hash(_this.settings),_this.newDomain,_this.profileTitle,_this.accountUsername,_this.proxiesView,_this.themeHex);
}
...
@useResult
$Res call({
 bool hwidMaxDevicesReached, bool hwidNotSupported, String? announce, String? supportUrl, int? updateIntervalMinutes, String? serviceName, String? serviceLogo, String? serverInfoGroup, String? buyPlanUrl, String? buyTrafficUrl, List<String>? widgets, PanelWidgetsApplyMode widgetsApplyMode, List<String>? settings, String? newDomain, String? profileTitle, String? accountUsername, String? proxiesView, String? themeHex
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool hwidMaxDevicesReached,  bool hwidNotSupported,  String? announce,  String? supportUrl,  int? updateIntervalMinutes,  String? serviceName,  String? serviceLogo,  String? serverInfoGroup,  String? buyPlanUrl,  String? buyTrafficUrl,  List<String>? widgets,  PanelWidgetsApplyMode widgetsApplyMode,  List<String>? settings,  String? newDomain,  String? profileTitle,  String? accountUsername,  String? proxiesView,  String? themeHex)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PanelMeta() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool hwidMaxDevicesReached,  bool hwidNotSupported,  String? announce,  String? supportUrl,  int? updateIntervalMinutes,  String? serviceName,  String? serviceLogo,  String? serverInfoGroup,  String? buyPlanUrl,  String? buyTrafficUrl,  List<String>? widgets,  PanelWidgetsApplyMode widgetsApplyMode,  List<String>? settings,  String? newDomain,  String? profileTitle,  String? accountUsername,  String? proxiesView,  String? themeHex)  $default,) {final _that = this;
switch (_that) {
case _PanelMeta():
return $default(_that.hwidMaxDevicesReached,_that.hwidNotSupported,_that.announce,_that.supportUrl,_that.updateIntervalMinutes,_that.serviceName,_that.serviceLogo,_that.serverInfoGroup,_that.buyPlanUrl,_that.buyTrafficUrl,_that.widgets,_that.widgetsApplyMode,_that.settings,_that.newDomain,_that.profileTitle,_that.accountUsername,_that.proxiesView,_that.themeHex);case _:
  throw StateError('Unexpected subclass');
...
@override
int get hashCode {
    return Object.hash(runtimeType,hwidMaxDevicesReached,hwidNotSupported,announce,supportUrl,updateIntervalMinutes,serviceName,serviceLogo,serverInfoGroup,buyPlanUrl,buyTrafficUrl,const DeepCollectionEquality().hash(_widgets),widgetsApplyMode,const DeepCollectionEquality().hash(_settings),newDomain,profileTitle,accountUsername,proxiesView,themeHex);
}
