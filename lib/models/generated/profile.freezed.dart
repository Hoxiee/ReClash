...
int get hashCode {
  final _this = this as Profile;
  return Object.hashAll([runtimeType,_this.id,_this.label,_this.currentGroupName,_this.url,_this.lastUpdateDate,_this.autoUpdateDuration,_this.subscriptionInfo,_this.panelMeta,_this.capabilityManifest,const DeepCollectionEquality().hash(_this.serviceRoutePolicies),const DeepCollectionEquality().hash(_this.manualCapabilitySelectors),_this.capabilityManifestIssue,_this.autoUpdate,const DeepCollectionEquality().hash(_this.selectedMap),const DeepCollectionEquality().hash(_this.unfoldSet),_this.overwriteType,_this.scriptId,_this.matchTarget,_this.order,_this.clientEmulation,_this.customUserAgent,_this.lastWorkingClient,const DeepCollectionEquality().hash(_this.skippedNodes),_this.undialableNodes,_this.userLabel]);
}

@override
String toString() {
  final _this = this as Profile;
  return 'Profile(id: ${_this.id}, label: ${_this.label}, currentGroupName: ${_this.currentGroupName}, url: ${_this.url}, lastUpdateDate: ${_this.lastUpdateDate}, autoUpdateDuration: ${_this.autoUpdateDuration}, subscriptionInfo: ${_this.subscriptionInfo}, panelMeta: ${_this.panelMeta}, capabilityManifest: ${_this.capabilityManifest}, serviceRoutePolicies: ${_this.serviceRoutePolicies}, manualCapabilitySelectors: ${_this.manualCapabilitySelectors}, capabilityManifestIssue: ${_this.capabilityManifestIssue}, autoUpdate: ${_this.autoUpdate}, selectedMap: ${_this.selectedMap}, unfoldSet: ${_this.unfoldSet}, overwriteType: ${_this.overwriteType}, scriptId: ${_this.scriptId}, matchTarget: ${_this.matchTarget}, order: ${_this.order}, clientEmulation: ${_this.clientEmulation}, customUserAgent: ${_this.customUserAgent}, lastWorkingClient: ${_this.lastWorkingClient}, skippedNodes: ${_this.skippedNodes}, undialableNodes: ${_this.undialableNodes}, userLabel: ${_this.userLabel})';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String label,  String? currentGroupName,  String url,  DateTime? lastUpdateDate,  Duration autoUpdateDuration,  SubscriptionInfo? subscriptionInfo,  PanelMeta? panelMeta,  ProviderCapabilityManifest? capabilityManifest,  List<ServiceRoutePolicy> serviceRoutePolicies,  List<ManualCapabilitySelector> manualCapabilitySelectors,  CapabilityManifestIssue? capabilityManifestIssue,  bool autoUpdate,  Map<String, String> selectedMap,  Set<String> unfoldSet,  OverwriteType overwriteType,  int? scriptId,  String? matchTarget,  int? order,  SubscriptionClient clientEmulation,  String customUserAgent, @JsonKey(includeToJson: false, includeFromJson: false)  SubscriptionClient? lastWorkingClient, @SkippedNodesConverter()  List<SkippedNode> skippedNodes,  bool undialableNodes,  bool userLabel)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Profile() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String label,  String? currentGroupName,  String url,  DateTime? lastUpdateDate,  Duration autoUpdateDuration,  SubscriptionInfo? subscriptionInfo,  PanelMeta? panelMeta,  ProviderCapabilityManifest? capabilityManifest,  List<ServiceRoutePolicy> serviceRoutePolicies,  List<ManualCapabilitySelector> manualCapabilitySelectors,  CapabilityManifestIssue? capabilityManifestIssue,  bool autoUpdate,  Map<String, String> selectedMap,  Set<String> unfoldSet,  OverwriteType overwriteType,  int? scriptId,  String? matchTarget,  int? order,  SubscriptionClient clientEmulation,  String customUserAgent, @JsonKey(includeToJson: false, includeFromJson: false)  SubscriptionClient? lastWorkingClient, @SkippedNodesConverter()  List<SkippedNode> skippedNodes,  bool undialableNodes,  bool userLabel)  $default,) {final _that = this;
switch (_that) {
case _Profile():
return $default(_that.id,_that.label,_that.currentGroupName,_that.url,_that.lastUpdateDate,_that.autoUpdateDuration,_that.subscriptionInfo,_that.panelMeta,_that.capabilityManifest,_that.serviceRoutePolicies,_that.manualCapabilitySelectors,_that.capabilityManifestIssue,_that.autoUpdate,_that.selectedMap,_that.unfoldSet,_that.overwriteType,_that.scriptId,_that.matchTarget,_that.order,_that.clientEmulation,_that.customUserAgent,_that.lastWorkingClient,_that.skippedNodes,_that.undialableNodes,_that.userLabel);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String label,  String? currentGroupName,  String url,  DateTime? lastUpdateDate,  Duration autoUpdateDuration,  SubscriptionInfo? subscriptionInfo,  PanelMeta? panelMeta,  ProviderCapabilityManifest? capabilityManifest,  List<ServiceRoutePolicy> serviceRoutePolicies,  List<ManualCapabilitySelector> manualCapabilitySelectors,  CapabilityManifestIssue? capabilityManifestIssue,  bool autoUpdate,  Map<String, String> selectedMap,  Set<String> unfoldSet,  OverwriteType overwriteType,  int? scriptId,  String? matchTarget,  int? order,  SubscriptionClient clientEmulation,  String customUserAgent, @JsonKey(includeToJson: false, includeFromJson: false)  SubscriptionClient? lastWorkingClient, @SkippedNodesConverter()  List<SkippedNode> skippedNodes,  bool undialableNodes,  bool userLabel)?  $default,) {final _that = this;
switch (_that) {
case _Profile() when $default != null:
return $default(_that.id,_that.label,_that.currentGroupName,_that.url,_that.lastUpdateDate,_that.autoUpdateDuration,_that.subscriptionInfo,_that.panelMeta,_that.capabilityManifest,_that.serviceRoutePolicies,_that.manualCapabilitySelectors,_that.capabilityManifestIssue,_that.autoUpdate,_that.selectedMap,_that.unfoldSet,_that.overwriteType,_that.scriptId,_that.matchTarget,_that.order,_that.clientEmulation,_that.customUserAgent,_that.lastWorkingClient,_that.skippedNodes,_that.undialableNodes,_that.userLabel);case _:
  return null;
...
class _Profile implements Profile {
  const _Profile({required this.id, this.label = '', this.currentGroupName, this.url = '', this.lastUpdateDate, required this.autoUpdateDuration, this.subscriptionInfo, this.panelMeta, this.capabilityManifest,  List<ServiceRoutePolicy> serviceRoutePolicies = const [],  List<ManualCapabilitySelector> manualCapabilitySelectors = const [], this.capabilityManifestIssue, this.autoUpdate = true,  Map<String, String> selectedMap = const {},  Set<String> unfoldSet = const {}, this.overwriteType = OverwriteType.standard, this.scriptId, this.matchTarget, this.order, this.clientEmulation = SubscriptionClient.auto, this.customUserAgent = '', @JsonKey(includeToJson: false, includeFromJson: false) this.lastWorkingClient, @SkippedNodesConverter()  List<SkippedNode> skippedNodes = const [], this.undialableNodes = false, this.userLabel = false}): _serviceRoutePolicies = serviceRoutePolicies,_manualCapabilitySelectors = manualCapabilitySelectors,_selectedMap = selectedMap,_unfoldSet = unfoldSet,_skippedNodes = skippedNodes;
...
/// Create a copy of Profile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? label = null,Object? currentGroupName = freezed,Object? url = null,Object? lastUpdateDate = freezed,Object? autoUpdateDuration = null,Object? subscriptionInfo = freezed,Object? panelMeta = freezed,Object? capabilityManifest = freezed,Object? serviceRoutePolicies = null,Object? manualCapabilitySelectors = null,Object? capabilityManifestIssue = freezed,Object? autoUpdate = null,Object? selectedMap = null,Object? unfoldSet = null,Object? overwriteType = null,Object? scriptId = freezed,Object? matchTarget = freezed,Object? order = freezed,Object? clientEmulation = null,Object? customUserAgent = null,Object? lastWorkingClient = freezed,Object? skippedNodes = null,Object? undialableNodes = null,Object? userLabel = null,}) {
