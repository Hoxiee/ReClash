...
mixin _$Profile {
 ...
 int get id; String get label; String? get currentGroupName; String get url; DateTime? get lastUpdateDate; DateTime? get lastUsedAt; Duration get autoUpdateDuration; SubscriptionInfo? get subscriptionInfo; PanelMeta? get panelMeta; ProviderCapabilityManifest? get capabilityManifest; List<ServiceRoutePolicy> get serviceRoutePolicies; List<ManualCapabilitySelector> get manualCapabilitySelectors; CapabilityManifestIssue? get capabilityManifestIssue; bool get autoUpdate; Map<String, String> get selectedMap; Set<String> get unfoldSet; OverwriteType get overwriteType; int? get scriptId; String? get matchTarget; int? get order;@JsonKey(name: 'clientEmulation') SubscriptionClient get clientCompatibility; String get customUserAgent;@JsonKey(includeToJson: false, includeFromJson: false) SubscriptionClient? get lastWorkingClient;@SkippedNodesConverter() List<SkippedNode> get skippedNodes; bool get undialableNodes; bool get userLabel;
...
int get hashCode {
  final _this = this as Profile;
  return Object.hashAll([runtimeType,_this.id,_this.label,_this.currentGroupName,_this.url,_this.lastUpdateDate,_this.lastUsedAt,_this.autoUpdateDuration,_this.subscriptionInfo,_this.panelMeta,_this.capabilityManifest,const DeepCollectionEquality().hash(_this.serviceRoutePolicies),const DeepCollectionEquality().hash(_this.manualCapabilitySelectors),_this.capabilityManifestIssue,_this.autoUpdate,const DeepCollectionEquality().hash(_this.selectedMap),const DeepCollectionEquality().hash(_this.unfoldSet),_this.overwriteType,_this.scriptId,_this.matchTarget,_this.order,_this.clientCompatibility,_this.customUserAgent,_this.lastWorkingClient,const DeepCollectionEquality().hash(_this.skippedNodes),_this.undialableNodes,_this.userLabel]);
}

@override
String toString() {
  final _this = this as Profile;
  return 'Profile(id: ${_this.id}, label: ${_this.label}, currentGroupName: ${_this.currentGroupName}, url: ${_this.url}, lastUpdateDate: ${_this.lastUpdateDate}, lastUsedAt: ${_this.lastUsedAt}, autoUpdateDuration: ${_this.autoUpdateDuration}, subscriptionInfo: ${_this.subscriptionInfo}, panelMeta: ${_this.panelMeta}, capabilityManifest: ${_this.capabilityManifest}, serviceRoutePolicies: ${_this.serviceRoutePolicies}, manualCapabilitySelectors: ${_this.manualCapabilitySelectors}, capabilityManifestIssue: ${_this.capabilityManifestIssue}, autoUpdate: ${_this.autoUpdate}, selectedMap: ${_this.selectedMap}, unfoldSet: ${_this.unfoldSet}, overwriteType: ${_this.overwriteType}, scriptId: ${_this.scriptId}, matchTarget: ${_this.matchTarget}, order: ${_this.order}, clientCompatibility: ${_this.clientCompatibility}, customUserAgent: ${_this.customUserAgent}, lastWorkingClient: ${_this.lastWorkingClient}, skippedNodes: ${_this.skippedNodes}, undialableNodes: ${_this.undialableNodes}, userLabel: ${_this.userLabel})';
}
...
@useResult
$Res call({
 int id, String label, String? currentGroupName, String url, DateTime? lastUpdateDate, DateTime? lastUsedAt, Duration autoUpdateDuration, SubscriptionInfo? subscriptionInfo, PanelMeta? panelMeta, ProviderCapabilityManifest? capabilityManifest, List<ServiceRoutePolicy> serviceRoutePolicies, List<ManualCapabilitySelector> manualCapabilitySelectors, CapabilityManifestIssue? capabilityManifestIssue, bool autoUpdate, Map<String, String> selectedMap, Set<String> unfoldSet, OverwriteType overwriteType, int? scriptId, String? matchTarget, int? order,@JsonKey(name: 'clientEmulation') SubscriptionClient clientCompatibility, String customUserAgent,@JsonKey(includeToJson: false, includeFromJson: false) SubscriptionClient? lastWorkingClient,@SkippedNodesConverter() List<SkippedNode> skippedNodes, bool undialableNodes, bool userLabel
});


$SubscriptionInfoCopyWith<$Res>? get subscriptionInfo;$PanelMetaCopyWith<$Res>? get panelMeta;$ProviderCapabilityManifestCopyWith<$Res>? get capabilityManifest;
...
/// Create a copy of Profile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? label = null,Object? currentGroupName = freezed,Object? url = null,Object? lastUpdateDate = freezed,Object? lastUsedAt = freezed,Object? autoUpdateDuration = null,Object? subscriptionInfo = freezed,Object? panelMeta = freezed,Object? capabilityManifest = freezed,Object? serviceRoutePolicies = null,Object? manualCapabilitySelectors = null,Object? capabilityManifestIssue = freezed,Object? autoUpdate = null,Object? selectedMap = null,Object? unfoldSet = null,Object? overwriteType = null,Object? scriptId = freezed,Object? matchTarget = freezed,Object? order = freezed,Object? clientCompatibility = null,Object? customUserAgent = null,Object? lastWorkingClient = freezed,Object? skippedNodes = null,Object? undialableNodes = null,Object? userLabel = null,}) {
...
as SubscriptionInfo?,panelMeta: freezed == panelMeta ? _self.panelMeta : panelMeta // ignore: cast_nullable_to_non_nullable
as PanelMeta?,capabilityManifest: freezed == capabilityManifest ? _self.capabilityManifest : capabilityManifest // ignore: cast_nullable_to_non_nullable
as ProviderCapabilityManifest?,serviceRoutePolicies: null == serviceRoutePolicies ? _self.serviceRoutePolicies : serviceRoutePolicies // ignore: cast_nullable_to_non_nullable
as List<ServiceRoutePolicy>,manualCapabilitySelectors: null == manualCapabilitySelectors ? _self.manualCapabilitySelectors : manualCapabilitySelectors // ignore: cast_nullable_to_non_nullable
as List<ManualCapabilitySelector>,capabilityManifestIssue: freezed == capabilityManifestIssue ? _self.capabilityManifestIssue : capabilityManifestIssue // ignore: cast_nullable_to_non_nullable
as CapabilityManifestIssue?,autoUpdate: null == autoUpdate ? _self.autoUpdate : autoUpdate // ignore: cast_nullable_to_non_nullable
...
as int?,clientCompatibility: null == clientCompatibility ? _self.clientCompatibility : clientCompatibility // ignore: cast_nullable_to_non_nullable
as SubscriptionClient,customUserAgent: null == customUserAgent ? _self.customUserAgent : customUserAgent // ignore: cast_nullable_to_non_nullable
as String,lastWorkingClient: freezed == lastWorkingClient ? _self.lastWorkingClient : lastWorkingClient // ignore: cast_nullable_to_non_nullable
as SubscriptionClient?,skippedNodes: null == skippedNodes ? _self.skippedNodes : skippedNodes // ignore: cast_nullable_to_non_nullable
as List<SkippedNode>,undialableNodes: null == undialableNodes ? _self.undialableNodes : undialableNodes // ignore: cast_nullable_to_non_nullable
as bool,userLabel: null == userLabel ? _self.userLabel : userLabel // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of Profile
...
@override
@pragma('vm:prefer-inline')
$PanelMetaCopyWith<$Res>? get panelMeta {
    if (_self.panelMeta == null) {
    return null;
  }

  return $PanelMetaCopyWith<$Res>(_self.panelMeta!, (value) {
    return _then(_self.copyWith(panelMeta: value));
  });
}/// Create a copy of Profile
/// with the given fields replaced by the non-null parameter values.
@override
@pragma('vm:prefer-inline')
$ProviderCapabilityManifestCopyWith<$Res>? get capabilityManifest {
    if (_self.capabilityManifest == null) {
    return null;
  }

  return $ProviderCapabilityManifestCopyWith<$Res>(_self.capabilityManifest!, (value) {
    return _then(_self.copyWith(capabilityManifest: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String label,  String? currentGroupName,  String url,  DateTime? lastUpdateDate,  DateTime? lastUsedAt,  Duration autoUpdateDuration,  SubscriptionInfo? subscriptionInfo,  PanelMeta? panelMeta,  ProviderCapabilityManifest? capabilityManifest,  List<ServiceRoutePolicy> serviceRoutePolicies,  List<ManualCapabilitySelector> manualCapabilitySelectors,  CapabilityManifestIssue? capabilityManifestIssue,  bool autoUpdate,  Map<String, String> selectedMap,  Set<String> unfoldSet,  OverwriteType overwriteType,  int? scriptId,  String? matchTarget,  int? order, @JsonKey(name: 'clientEmulation')  SubscriptionClient clientCompatibility,  String customUserAgent, @JsonKey(includeToJson: false, includeFromJson: false)  SubscriptionClient? lastWorkingClient, @SkippedNodesConverter()  List<SkippedNode> skippedNodes,  bool undialableNodes,  bool userLabel)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Profile() when $default != null:
return $default(_that.id,_that.label,_that.currentGroupName,_that.url,_that.lastUpdateDate,_that.lastUsedAt,_that.autoUpdateDuration,_that.subscriptionInfo,_that.panelMeta,_that.capabilityManifest,_that.serviceRoutePolicies,_that.manualCapabilitySelectors,_that.capabilityManifestIssue,_that.autoUpdate,_that.selectedMap,_that.unfoldSet,_that.overwriteType,_that.scriptId,_that.matchTarget,_that.order,_that.clientCompatibility,_that.customUserAgent,_that.lastWorkingClient,_that.skippedNodes,_that.undialableNodes,_that.userLabel);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String label,  String? currentGroupName,  String url,  DateTime? lastUpdateDate,  DateTime? lastUsedAt,  Duration autoUpdateDuration,  SubscriptionInfo? subscriptionInfo,  PanelMeta? panelMeta,  ProviderCapabilityManifest? capabilityManifest,  List<ServiceRoutePolicy> serviceRoutePolicies,  List<ManualCapabilitySelector> manualCapabilitySelectors,  CapabilityManifestIssue? capabilityManifestIssue,  bool autoUpdate,  Map<String, String> selectedMap,  Set<String> unfoldSet,  OverwriteType overwriteType,  int? scriptId,  String? matchTarget,  int? order, @JsonKey(name: 'clientEmulation')  SubscriptionClient clientCompatibility,  String customUserAgent, @JsonKey(includeToJson: false, includeFromJson: false)  SubscriptionClient? lastWorkingClient, @SkippedNodesConverter()  List<SkippedNode> skippedNodes,  bool undialableNodes,  bool userLabel)  $default,) {final _that = this;
switch (_that) {
case _Profile():
return $default(_that.id,_that.label,_that.currentGroupName,_that.url,_that.lastUpdateDate,_that.lastUsedAt,_that.autoUpdateDuration,_that.subscriptionInfo,_that.panelMeta,_that.capabilityManifest,_that.serviceRoutePolicies,_that.manualCapabilitySelectors,_that.capabilityManifestIssue,_that.autoUpdate,_that.selectedMap,_that.unfoldSet,_that.overwriteType,_that.scriptId,_that.matchTarget,_that.order,_that.clientCompatibility,_that.customUserAgent,_that.lastWorkingClient,_that.skippedNodes,_that.undialableNodes,_that.userLabel);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String label,  String? currentGroupName,  String url,  DateTime? lastUpdateDate,  DateTime? lastUsedAt,  Duration autoUpdateDuration,  SubscriptionInfo? subscriptionInfo,  PanelMeta? panelMeta,  ProviderCapabilityManifest? capabilityManifest,  List<ServiceRoutePolicy> serviceRoutePolicies,  List<ManualCapabilitySelector> manualCapabilitySelectors,  CapabilityManifestIssue? capabilityManifestIssue,  bool autoUpdate,  Map<String, String> selectedMap,  Set<String> unfoldSet,  OverwriteType overwriteType,  int? scriptId,  String? matchTarget,  int? order, @JsonKey(name: 'clientEmulation')  SubscriptionClient clientCompatibility,  String customUserAgent, @JsonKey(includeToJson: false, includeFromJson: false)  SubscriptionClient? lastWorkingClient, @SkippedNodesConverter()  List<SkippedNode> skippedNodes,  bool undialableNodes,  bool userLabel)?  $default,) {final _that = this;
switch (_that) {
case _Profile() when $default != null:
return $default(_that.id,_that.label,_that.currentGroupName,_that.url,_that.lastUpdateDate,_that.lastUsedAt,_that.autoUpdateDuration,_that.subscriptionInfo,_that.panelMeta,_that.capabilityManifest,_that.serviceRoutePolicies,_that.manualCapabilitySelectors,_that.capabilityManifestIssue,_that.autoUpdate,_that.selectedMap,_that.unfoldSet,_that.overwriteType,_that.scriptId,_that.matchTarget,_that.order,_that.clientCompatibility,_that.customUserAgent,_that.lastWorkingClient,_that.skippedNodes,_that.undialableNodes,_that.userLabel);case _:
  return null;
...
class _Profile implements Profile {
  const _Profile({required this.id, this.label = '', this.currentGroupName, this.url = '', this.lastUpdateDate, this.lastUsedAt, required this.autoUpdateDuration, this.subscriptionInfo, this.panelMeta, this.capabilityManifest,  List<ServiceRoutePolicy> serviceRoutePolicies = const [],  List<ManualCapabilitySelector> manualCapabilitySelectors = const [], this.capabilityManifestIssue, this.autoUpdate = true,  Map<String, String> selectedMap = const {},  Set<String> unfoldSet = const {}, this.overwriteType = OverwriteType.standard, this.scriptId, this.matchTarget, this.order, @JsonKey(name: 'clientEmulation') this.clientCompatibility = SubscriptionClient.auto, this.customUserAgent = '', @JsonKey(includeToJson: false, includeFromJson: false) this.lastWorkingClient, @SkippedNodesConverter()  List<SkippedNode> skippedNodes = const [], this.undialableNodes = false, this.userLabel = false}): _serviceRoutePolicies = serviceRoutePolicies,_manualCapabilitySelectors = manualCapabilitySelectors,_selectedMap = selectedMap,_unfoldSet = unfoldSet,_skippedNodes = skippedNodes;
...
@override final  PanelMeta? panelMeta;
@override final  ProviderCapabilityManifest? capabilityManifest;
...
@override@JsonKey() List<ServiceRoutePolicy> get serviceRoutePolicies {
 ...
 final  List<ManualCapabilitySelector> _manualCapabilitySelectors;
@override@JsonKey() List<ManualCapabilitySelector> get manualCapabilitySelectors {
  if (_manualCapabilitySelectors is EqualUnmodifiableListView) return _manualCapabilitySelectors;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_manualCapabilitySelectors);
}

@override final  CapabilityManifestIssue? capabilityManifestIssue;
...
@override@JsonKey(name: 'clientEmulation') final  SubscriptionClient clientCompatibility;
@override@JsonKey() final  String customUserAgent;
@override@JsonKey(includeToJson: false, includeFromJson: false) final  SubscriptionClient? lastWorkingClient;
 final  List<SkippedNode> _skippedNodes;
@override@JsonKey()@SkippedNodesConverter() List<SkippedNode> get skippedNodes {
  if (_skippedNodes is EqualUnmodifiableListView) return _skippedNodes;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_skippedNodes);
}

@override@JsonKey() final  bool undialableNodes;
@override@JsonKey() final  bool userLabel;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _Profile&&(identical(other.id, id) || other.id == id)&&(identical(other.label, label) || other.label == label)&&(identical(other.currentGroupName, currentGroupName) || other.currentGroupName == currentGroupName)&&(identical(other.url, url) || other.url == url)&&(identical(other.lastUpdateDate, lastUpdateDate) || other.lastUpdateDate == lastUpdateDate)&&(identical(other.lastUsedAt, lastUsedAt) || other.lastUsedAt == lastUsedAt)&&(identical(other.autoUpdateDuration, autoUpdateDuration) || other.autoUpdateDuration == autoUpdateDuration)&&(identical(other.subscriptionInfo, subscriptionInfo) || other.subscriptionInfo == subscriptionInfo)&&(identical(other.panelMeta, panelMeta) || other.panelMeta == panelMeta)&&(identical(other.capabilityManifest, capabilityManifest) || other.capabilityManifest == capabilityManifest)&&const DeepCollectionEquality().equals(other.serviceRoutePolicies, _serviceRoutePolicies)&&const DeepCollectionEquality().equals(other.manualCapabilitySelectors, _manualCapabilitySelectors)&&(identical(other.capabilityManifestIssue, capabilityManifestIssue) || other.capabilityManifestIssue == capabilityManifestIssue)&&(identical(other.autoUpdate, autoUpdate) || other.autoUpdate == autoUpdate)&&const DeepCollectionEquality().equals(other.selectedMap, _selectedMap)&&const DeepCollectionEquality().equals(other.unfoldSet, _unfoldSet)&&(identical(other.overwriteType, overwriteType) || other.overwriteType == overwriteType)&&(identical(other.scriptId, scriptId) || other.scriptId == scriptId)&&(identical(other.matchTarget, matchTarget) || other.matchTarget == matchTarget)&&(identical(other.order, order) || other.order == order)&&(identical(other.clientCompatibility, clientCompatibility) || other.clientCompatibility == clientCompatibility)&&(identical(other.customUserAgent, customUserAgent) || other.customUserAgent == customUserAgent)&&(identical(other.lastWorkingClient, lastWorkingClient) || other.lastWorkingClient == lastWorkingClient)&&const DeepCollectionEquality().equals(other.skippedNodes, _skippedNodes)&&(identical(other.undialableNodes, undialableNodes) || other.undialableNodes == undialableNodes)&&(identical(other.userLabel, userLabel) || other.userLabel == userLabel));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hashAll([runtimeType,id,label,currentGroupName,url,lastUpdateDate,lastUsedAt,autoUpdateDuration,subscriptionInfo,panelMeta,capabilityManifest,const DeepCollectionEquality().hash(_serviceRoutePolicies),const DeepCollectionEquality().hash(_manualCapabilitySelectors),capabilityManifestIssue,autoUpdate,const DeepCollectionEquality().hash(_selectedMap),const DeepCollectionEquality().hash(_unfoldSet),overwriteType,scriptId,matchTarget,order,clientCompatibility,customUserAgent,lastWorkingClient,const DeepCollectionEquality().hash(_skippedNodes),undialableNodes,userLabel]);
}

@override
String toString() {
    return 'Profile(id: $id, label: $label, currentGroupName: $currentGroupName, url: $url, lastUpdateDate: $lastUpdateDate, lastUsedAt: $lastUsedAt, autoUpdateDuration: $autoUpdateDuration, subscriptionInfo: $subscriptionInfo, panelMeta: $panelMeta, capabilityManifest: $capabilityManifest, serviceRoutePolicies: $serviceRoutePolicies, manualCapabilitySelectors: $manualCapabilitySelectors, capabilityManifestIssue: $capabilityManifestIssue, autoUpdate: $autoUpdate, selectedMap: $selectedMap, unfoldSet: $unfoldSet, overwriteType: $overwriteType, scriptId: $scriptId, matchTarget: $matchTarget, order: $order, clientCompatibility: $clientCompatibility, customUserAgent: $customUserAgent, lastWorkingClient: $lastWorkingClient, skippedNodes: $skippedNodes, undialableNodes: $undialableNodes, userLabel: $userLabel)';
}
...
@override $SubscriptionInfoCopyWith<$Res>? get subscriptionInfo;@override $PanelMetaCopyWith<$Res>? get panelMeta;@override $ProviderCapabilityManifestCopyWith<$Res>? get capabilityManifest;
...
/// Create a copy of Profile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? label = null,Object? currentGroupName = freezed,Object? url = null,Object? lastUpdateDate = freezed,Object? lastUsedAt = freezed,Object? autoUpdateDuration = null,Object? subscriptionInfo = freezed,Object? panelMeta = freezed,Object? capabilityManifest = freezed,Object? serviceRoutePolicies = null,Object? manualCapabilitySelectors = null,Object? capabilityManifestIssue = freezed,Object? autoUpdate = null,Object? selectedMap = null,Object? unfoldSet = null,Object? overwriteType = null,Object? scriptId = freezed,Object? matchTarget = freezed,Object? order = freezed,Object? clientCompatibility = null,Object? customUserAgent = null,Object? lastWorkingClient = freezed,Object? skippedNodes = null,Object? undialableNodes = null,Object? userLabel = null,}) {
...
as SubscriptionInfo?,panelMeta: freezed == panelMeta ? _self.panelMeta : panelMeta // ignore: cast_nullable_to_non_nullable
as PanelMeta?,capabilityManifest: freezed == capabilityManifest ? _self.capabilityManifest : capabilityManifest // ignore: cast_nullable_to_non_nullable
as ProviderCapabilityManifest?,serviceRoutePolicies: null == serviceRoutePolicies ? _self._serviceRoutePolicies : serviceRoutePolicies // ignore: cast_nullable_to_non_nullable
as List<ServiceRoutePolicy>,manualCapabilitySelectors: null == manualCapabilitySelectors ? _self._manualCapabilitySelectors : manualCapabilitySelectors // ignore: cast_nullable_to_non_nullable
as List<ManualCapabilitySelector>,capabilityManifestIssue: freezed == capabilityManifestIssue ? _self.capabilityManifestIssue : capabilityManifestIssue // ignore: cast_nullable_to_non_nullable
as CapabilityManifestIssue?,autoUpdate: null == autoUpdate ? _self.autoUpdate : autoUpdate // ignore: cast_nullable_to_non_nullable
...
as SubscriptionClient,customUserAgent: null == customUserAgent ? _self.customUserAgent : customUserAgent // ignore: cast_nullable_to_non_nullable
as String,lastWorkingClient: freezed == lastWorkingClient ? _self.lastWorkingClient : lastWorkingClient // ignore: cast_nullable_to_non_nullable
as SubscriptionClient?,skippedNodes: null == skippedNodes ? _self._skippedNodes : skippedNodes // ignore: cast_nullable_to_non_nullable
as List<SkippedNode>,undialableNodes: null == undialableNodes ? _self.undialableNodes : undialableNodes // ignore: cast_nullable_to_non_nullable
as bool,userLabel: null == userLabel ? _self.userLabel : userLabel // ignore: cast_nullable_to_non_nullable
as bool,
  ));
