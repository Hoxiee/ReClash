...
as int?,clientEmulation: null == clientEmulation ? _self.clientEmulation : clientEmulation // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Profile() when $default != null:
return $default(_that.id,_that.label,_that.currentGroupName,_that.url,_that.lastUpdateDate,_that.lastUsedAt,_that.autoUpdateDuration,_that.subscriptionInfo,_that.panelMeta,_that.capabilityManifest,_that.serviceRoutePolicies,_that.manualCapabilitySelectors,_that.capabilityManifestIssue,_that.autoUpdate,_that.selectedMap,_that.unfoldSet,_that.overwriteType,_that.scriptId,_that.matchTarget,_that.order,_that.clientEmulation,_that.customUserAgent,_that.lastWorkingClient,_that.skippedNodes,_that.undialableNodes,_that.userLabel);case _:
  return orElse();
...
class _Profile implements Profile {
  const _Profile({required this.id, this.label = '', this.currentGroupName, this.url = '', this.lastUpdateDate, this.lastUsedAt, required this.autoUpdateDuration, this.subscriptionInfo, this.panelMeta, this.capabilityManifest,  List<ServiceRoutePolicy> serviceRoutePolicies = const [],  List<ManualCapabilitySelector> manualCapabilitySelectors = const [], this.capabilityManifestIssue, this.autoUpdate = true,  Map<String, String> selectedMap = const {},  Set<String> unfoldSet = const {}, this.overwriteType = OverwriteType.standard, this.scriptId, this.matchTarget, this.order, this.clientEmulation = SubscriptionClient.auto, this.customUserAgent = '', @JsonKey(includeToJson: false, includeFromJson: false) this.lastWorkingClient, @SkippedNodesConverter()  List<SkippedNode> skippedNodes = const [], this.undialableNodes = false, this.userLabel = false}): _serviceRoutePolicies = serviceRoutePolicies,_manualCapabilitySelectors = manualCapabilitySelectors,_selectedMap = selectedMap,_unfoldSet = unfoldSet,_skippedNodes = skippedNodes;
...
@override@JsonKey() final  SubscriptionClient clientEmulation;
