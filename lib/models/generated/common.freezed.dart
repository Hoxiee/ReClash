...
class _DnsQuery implements DnsQuery {
  const _DnsQuery({this.domain = '', this.type = '', @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) this.initiator, this.upstream = '', this.cached = false,  List<String> answers = const [], this.rcode = '', this.error = '', this.delay = 0, required this.time}): _answers = answers;
...
mixin _$DnsQueriesState {
 ...
 List<DnsQuery> get dnsQueries; List<String> get keywords; String get query; bool get useRegex; bool get autoScrollToEnd;
...
int get hashCode {
  final _this = this as DnsQueriesState;
  return Object.hash(runtimeType,const DeepCollectionEquality().hash(_this.dnsQueries),const DeepCollectionEquality().hash(_this.keywords),_this.query,_this.useRegex,_this.autoScrollToEnd);
}

@override
String toString() {
  final _this = this as DnsQueriesState;
  return 'DnsQueriesState(dnsQueries: ${_this.dnsQueries}, keywords: ${_this.keywords}, query: ${_this.query}, useRegex: ${_this.useRegex}, autoScrollToEnd: ${_this.autoScrollToEnd})';
}
...
@useResult
$Res call({
 List<DnsQuery> dnsQueries, List<String> keywords, String query, bool useRegex, bool autoScrollToEnd
});
...
/// Create a copy of DnsQueriesState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dnsQueries = null,Object? keywords = null,Object? query = null,Object? useRegex = null,Object? autoScrollToEnd = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<DnsQuery> dnsQueries,  List<String> keywords,  String query,  bool useRegex,  bool autoScrollToEnd)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DnsQueriesState() when $default != null:
return $default(_that.dnsQueries,_that.keywords,_that.query,_that.useRegex,_that.autoScrollToEnd);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<DnsQuery> dnsQueries,  List<String> keywords,  String query,  bool useRegex,  bool autoScrollToEnd)  $default,) {final _that = this;
switch (_that) {
case _DnsQueriesState():
return $default(_that.dnsQueries,_that.keywords,_that.query,_that.useRegex,_that.autoScrollToEnd);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<DnsQuery> dnsQueries,  List<String> keywords,  String query,  bool useRegex,  bool autoScrollToEnd)?  $default,) {final _that = this;
switch (_that) {
case _DnsQueriesState() when $default != null:
return $default(_that.dnsQueries,_that.keywords,_that.query,_that.useRegex,_that.autoScrollToEnd);case _:
  return null;
...
class _DnsQueriesState implements DnsQueriesState {
  const _DnsQueriesState({ List<DnsQuery> dnsQueries = const [],  List<String> keywords = const [], this.query = '', this.useRegex = false, this.autoScrollToEnd = true}): _dnsQueries = dnsQueries,_keywords = keywords;
...
@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(_dnsQueries),const DeepCollectionEquality().hash(_keywords),query,useRegex,autoScrollToEnd);
}

@override
String toString() {
    return 'DnsQueriesState(dnsQueries: $dnsQueries, keywords: $keywords, query: $query, useRegex: $useRegex, autoScrollToEnd: $autoScrollToEnd)';
}
...
/// Create a copy of DnsQueriesState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dnsQueries = null,Object? keywords = null,Object? query = null,Object? useRegex = null,Object? autoScrollToEnd = null,}) {
