...
class _MemoryDetailSheetState extends State<MemoryDetailSheet> {
  ...
  List<Widget> _appItems(AppLocalizations appLocalizations, MemorySnapshot s) {
    return [
      _MemoryRow(
  ...
  List<Widget> _coreItems(AppLocalizations appLocalizations, MemorySnapshot s) {
    final core = s.core;
    if (core == null) {
      return [ListItem(title: Text(appLocalizations.memoryCoreNotRunning))];
    }
    final total = s.coreTotal;
    return [
      _MemoryRow(
