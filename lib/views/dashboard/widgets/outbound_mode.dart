  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (_, constraints) {
        final count = UiOutboundMode.values.length;
          ...
          builder: (context, position, _) {
            ...
            return Stack(
              children: [
                ...
                for (final (index, item) in UiOutboundMode.values.indexed)
                  Positioned(
                    left: pillInset,
                    right: pillInset,
...
Glyph _glyphOf(UiOutboundMode mode) {
  return switch (mode) {
    UiOutboundMode.auto => AppGlyphs.route,
    UiOutboundMode.rule => AppGlyphs.rules,
    UiOutboundMode.global => AppGlyphs.language,
    UiOutboundMode.direct => AppGlyphs.target,
  };
}
...
class _ModeColors {
  ...
  factory _ModeColors.of(BuildContext context, UiOutboundMode mode) {
    final colorScheme = context.colorScheme;
    return switch (mode) {
      UiOutboundMode.auto => _ModeColors(
        colorScheme.primaryContainer,
        colorScheme.onPrimaryContainer,
      ),
      UiOutboundMode.rule => _ModeColors(
