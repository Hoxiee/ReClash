...
/// Cards keep the phone height up to the grid a 680-wide window leaves beside
/// the collapsed sidebar, then grow with it (12-col cards stay under ~2.8:1).
...
class DashboardWidgetMetrics extends InheritedTheme {
  ...
  /// A row inset inside the card stays concentric until the radius passes a
  /// third of the row's [height]; past it a short row becomes a pill.
