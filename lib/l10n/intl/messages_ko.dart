...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(label) => "${label} 세부 정보";

  static String m9(label) => "${label}은(는) 비워 둘 수 없습니다";

  static String m10(count) =>
      "${Intl.plural(count, one: '항목 1개', other: '항목 ${count}개')}";

  static String m11(label) => "이미 ${label}이(가) 있습니다";

  static String m12(name) => "${name}은(는) 이미 최신 버전입니다";

  static String m13(name) => "${name}이(가) 업데이트됐습니다";

  static String m14(time) => "${time} 전";
  ...
  static String m17(target) => "${target}은(는) 잘못된 정책입니다";

  static String m18(proxyName) => "${proxyName}은(는) 잘못된 프록시입니다";

  static String m19(providerName) => "${providerName}은(는) 잘못된 프록시 공급자입니다";

  static String m20(subRule) => "${subRule}은(는) 잘못된 SUB_RULE입니다";

  static String m21(appName) =>
      "1. 시스템 설정 > 개인 정보 보호 및 보안을 엽니다\n2. 위치 서비스를 선택합니다\n3. 목록에서 ${appName}을(를) 찾아 켭니다\n\n설정을 마친 후 앱으로 돌아와 계속 진행하세요. 협조해 주셔서 감사합니다.";

  static String m22(label, max) => "${label}은(는) 최대 ${max}자여야 합니다";
  ...
  static String m25(label) => "아직 ${label}이(가) 없습니다";

  static String m26(label) => "${label}은(는) 숫자여야 합니다";

  static String m27(label) => "${label}은(는) 1024~49151 사이의 값이어야 합니다";
  ...
  static String m30(darkAt, lightAt) => "${darkAt}부터 ${lightAt}까지 다크 모드를 사용합니다";

  static String m31(count) =>
      "${Intl.plural(count, one: '1초', other: '${count}초')}";

  static String m32(count) => "${count}개 선택됨";

  static String m33(alive, total) => "지금 서버 ${total}개 중 ${alive}개 사용 가능";

  static String m34(band) => "구간 ${band}";

  static String m35(bands) => "대역: ${bands}";

  static String m36(count) => "실패 ${count}회 후 대기 중";

  static String m37(answered, total) => "${total}개 중 ${answered}개 응답";

  static String m38(seconds) => "${seconds}초 남음";

  static String m39(count) => "연속 ${count}회 실패";

  static String m40(measured, total) => "${total}개 중 ${measured}개 측정";

  static String m41(preset) => "${preset} · 조정됨";

  static String m42(left, cap) => "최근 1시간 동안 탐색 ${cap}회 중 ${left}회 남음";

  static String m43(seconds) => "${seconds}초";

  static String m44(eligible, total) => "${total}개 중 ${eligible}개 사용 가능";
  ...
  static String m47(time) => "${time} 전에 전환됨";

  static String m48(count) => "서버 ${count}개";

  static String m49(host) => "제공자가 ${host}(으)로 이동했습니다";

  static String m50(count) =>
      "${Intl.plural(count, one: '구독이 내일 만료됩니다', other: '구독이 ${count}일 후에 만료됩니다')}";

  static String m51(value) => "제공자 권장값: ${value}";

  static String m52(total) => "전체 ${total} 중 사용 가능";

  static String m53(label) => "${label}은(는) URL이어야 합니다";
